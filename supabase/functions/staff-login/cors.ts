// CORS helpers for the staff-login function.
// The allowed origin is configuration, never a wildcard: this endpoint mints
// auth tokens, so any origin may not call it.
